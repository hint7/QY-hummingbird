...
class RLMAV(gym.Env,
    ...
    def __init__(self,
        ...
        if pyb==None:
            ...
            self.set_env()
        else:#for multi-mavs using single pybullet
            self._p = pyb
    ...
    # the function prestep() and step_after_pyb() are used for multi-mavs using single p.stepSimulation()
    ...
    def reset_keep_env(self,
              seed: int = None, ):
        """Resets the environment, yet keep the single environment. For multi-mavs.
