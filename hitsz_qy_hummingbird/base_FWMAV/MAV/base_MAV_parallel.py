...
class BaseMavParellel(BaseMAV):
    ...
    def __init__(self,
        ...
        # the code below is moved to [wrapped_mav_for_RL.py] for multi-mavs using single pybullet
        #######################################################################################
    ...
    # def camera_fix(self):
    #     position = [0,0,0]
    #     self._p.resetDebugVisualizerCamera(cameraDistance=1,
    #                                  cameraYaw=170,
    #                                  cameraPitch=-20,
    #                                  cameraTargetPosition=position)
    # # for y hover
