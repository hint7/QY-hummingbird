...
class RLyaw(RLMAV):
    ...
    def step(self,
        ...
        obs = self._computeObs(trac_pos,trac_att)
    ...
    def reset(self,
        ...
        self._updateKinematic()
        initial_obs = self._computeObs(trac_pos,trac_att)
        initial_info = self._computeInfo()
        return initial_obs, initial_info
    
    def _computeObs(self,trac_pos,trac_att):
        ...
        """
        cur_obs = self._getDroneStateVector(trac_pos,trac_att)
    ...
    def _getDroneStateVector(self,trac_pos,trac_att):
        self.TARGET_POS = trac_pos 
        self.TARGET_RPY = trac_att
